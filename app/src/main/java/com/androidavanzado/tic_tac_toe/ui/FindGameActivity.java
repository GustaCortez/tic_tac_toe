...
public class FindGameActivity extends AppCompatActivity {
    ...
    private Button btnJugar,btnRanquin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRanquin=findViewById(R.id.buttonRanking);
    ...
    private void eventos() {
        ...
        btnRanquin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void buscarJugadaLibre() {
        tvLoadingMessage.setText("Bucando una jugada libre");
        animationView.playAnimation();
        db.collection("jugadas")
                .whereEqualTo("jugadorDosId",0)
                .get()
                                ...
                                db.collection("jugadas")
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                Toast.makeText(FindGameActivity.this, "Hubo algun error al entrar", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                break;
                            }//cerradura de la condicion else
    ...
    private void crearNuevaJugada() {
        ...
        db.collection("jugadas")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    // tenemos creadad la jugada debemos esperar a otro jugador
                        esperarJugador();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                ...
                .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException error) {
                        if (!documentSnapshot.get("jugadorDosId").equals("")){
                            tvLoadingMessage.setText("Ya llego el jugador, inicia la partida");
                            animationView.setRepeatCount(0);
                            animationView.setAnimation("checked_animation.json");
                            animationView.playAnimation();
    ...
    private void initProgressBar() {
        ...
        progressBar =findViewById(R.id.progressBarJugada);
